...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pewdiepie':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('pewdiepie','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'pewdiepie idle', 24, false);
				animation.addByPrefix('singUP', 'pewdiepie sing up', 24, false);
				animation.addByPrefix('singRIGHT', 'pewdiepies sing right', 24, false);
				animation.addByPrefix('singDOWN', 'pewdiepie sing up', 24, false);
				animation.addByPrefix('singLEFT', 'pewdiepies sing right', 24, false);
