...
class PlayState extends MusicBeatState
{
		...
		else
		{
			if (isStoryMode)
			{
				...
				if (storyPlaylist.length <= 0)
				{
					...
					if (curSong.toLowerCase() == 'brofist')
					{
						randomEnd = FlxG.random.int(0, 5);
						trace(randomEnd);
						if (randomEnd == 1)
							{
	...
	override function stepHit()
	{
		...
		#end		
		if (curSong.toLowerCase() == 'brofist' && curStep == 553)
		{
			FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
		}		
		if (curSong.toLowerCase() == 'brofist' && curStep == 618)
		{
			FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
		}
		if (curSong.toLowerCase() == 'brofist' && curStep == 681)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
			}		
		if (curSong.toLowerCase() == 'brofist' && curStep == 745)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
			}		
		if (curSong.toLowerCase() == 'brofist' && curStep == 1449)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
			}
		if (curSong.toLowerCase() == 'brofist' && curStep == 1513)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
			}
		if (curSong.toLowerCase() == 'brofist' && curStep == 1577)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
			}
		if (curSong.toLowerCase() == 'brofist' && curStep == 1641)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
			}
		if (curSong.toLowerCase() == 'brofist' && curStep == 1705)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
			}
		if (curSong.toLowerCase() == 'brofist' && curStep == 1769)
			{
				FlxTween.tween(FlxG.camera, {zoom: 1.5}, 0.4, {ease: FlxEase.cubeOut,});
			}
		if (curSong.toLowerCase() == 'brofist' && curStep == 1900)
			{
				FlxG.sound.play(Paths.sound('avast'));
			}
	}
